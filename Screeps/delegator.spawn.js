...
var delegatorSpawn = {
    ...
    run: function() {
        ...
        for (var id in Game.spawns) {
            ...
            //creepHarvester
            roleSpawn.run(spawn, ROLE_HARVESTER,MAX_HARVESTER,[WORK,WORK,WORK,WORK,WORK,MOVE])
            //creepDeliverer
            roleSpawn.run(spawn, ROLE_DELIVERER,MAX_DELIVERER,[CARRY,MOVE,CARRY,MOVE,CARRY,MOVE,CARRY,MOVE])    
            //creepBuilder
            roleSpawn.run(spawn, ROLE_BUILDER,MAX_BUILDER,[WORK,WORK,CARRY,MOVE,WORK,WORK,CARRY,MOVE])
            //creepRangeWorker
